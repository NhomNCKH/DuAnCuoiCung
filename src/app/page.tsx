        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link href="#khoa-hoc" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">
                Khóa học
              </Link>
              <Link href="#luyen-de" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">
                Luyện đề
              </Link>
              <Link href="#thi-thu" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">
                Thi thử
              </Link>
              <Link href="#thanh-tich" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">
                Thành tích
              </Link>
            </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  ...
                  <button className="px-6 py-3 border-2 border-blue-300 text-blue-700 rounded-xl font-semibold hover:bg-blue-50 transition-all flex items-center gap-2">
                ...
                <div className="flex items-center gap-6">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 border-2 border-white flex items-center justify-center text-white font-bold"
                      >
                  ...
                  <div className="text-sm text-slate-600">
                    <span className="font-bold text-slate-800">10,000+</span> học viên đã tin dùng
                  </div>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h2 className="text-4xl font-bold text-slate-800 mb-4">
                Lộ trình học tập <span className="text-blue-600">toàn diện</span>
              </h2>
              ...
              {features.map((feature, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-blue-500">{feature.stats}</span>
                    {!feature.comingSoon && (
                      <Link
                        href={feature.link}
        ...
        <section id="luyen-de" className="py-20 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-slate-800 mb-4">Cấu trúc bài thi Reading</h2>
              <p className="text-lg text-slate-500">Luyện tập từng Part với hệ thống bài tập đa dạng</p>
            </motion.div>
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <h3 className="text-lg font-semibold text-slate-800 mt-1">{part.title}</h3>
                    </div>
                    <div className="bg-blue-100 rounded-full px-3 py-1">
                      <span className="text-sm font-medium text-blue-700">{part.questions} câu</span>
                    </div>
                  </div>
                  <p className="text-slate-500 text-sm mb-3">{part.description}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-400">Độ khó: {part.difficulty}</span>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-indigo-100 rounded-full px-4 py-2 mb-4">
                ...
                <span className="text-sm font-medium text-indigo-700">Kỹ năng Viết</span>
              </div>
              <h2 className="text-3xl font-bold text-slate-800 mb-4">Cấu trúc bài thi Writing</h2>
              <p className="text-lg text-slate-500">Luyện viết với AI chấm điểm và gợi ý cải thiện</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {writingParts.map((part, idx) => (
                <motion.div
                  ...
                  transition={{ delay: idx * 0.1 }}
                  whileHover={{ scale: 1.02 }}
                  className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl p-6 border border-indigo-100 cursor-pointer"
                  onClick={() => router.push(`/student/writing/part${part.part.split(" ")[1]}`)}
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <span className="text-2xl font-bold text-indigo-600">{part.part}</span>
                      <h3 className="text-lg font-semibold text-slate-800 mt-1">{part.title}</h3>
                    </div>
                    <div className="bg-indigo-100 rounded-full px-3 py-1">
                      <span className="text-sm font-medium text-indigo-700">{part.questions} bài</span>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-blue-100 rounded-full px-4 py-2 mb-4">
                ...
                <span className="text-sm font-medium text-blue-700">Thi thử</span>
              </div>
              <h2 className="text-3xl font-bold text-slate-800 mb-4">Đề thi thử TOEIC</h2>
              <p className="text-lg text-slate-500">Làm quen với cấu trúc đề thi thật</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {mockTests.map((test, idx) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.1 }}
                  className="bg-white rounded-2xl p-6 border-2 border-slate-100 hover:border-blue-300 transition-all"
                >
                  <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold text-slate-700">{test.reading} câu</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-500">Writing</span>
                      <span className="font-semibold text-slate-700">{test.writing} câu</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-500">Thời gian</span>
                      <span className="font-semibold text-slate-700">{test.duration}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-500">Đã làm</span>
                      <span className="font-semibold text-slate-700">{test.students} học viên</span>
                    </div>
                  </div>
                  <button
                    onClick={() => {
